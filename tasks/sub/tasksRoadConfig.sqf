...
[
	...
	[
		...
		[
			"baseRoadblockGreenShot",
			"baseRoadblockBrokenMRAP",
			"baseRoadblockMission",
			"baseRoadblockRubbleTrouble",
			"roadBlockWreckRoad_CM"
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Road Block Intercept", // task title
		"Placeholder Description!", // task description
		["secure"], // task roles
		"ROAD", // task icon
		100, // task area radius (red outer circle)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Road Construction Intecept", // task title
		"It seems as though the enemy has dug up the road to try and intercept nato communications, go secure it soldiers so they can't get out intel!", // task description
		["secure"], // task roles
		"ROAD", // task icon
		150, // task area radius (red outer circle)
		15, // task base radius (for base placement)
		[
			"smallCheckPointRoad_CM"
		], // base compositions available
		"land", // location surface "land", "water", "bridge"
		2, // number of unit groups
		6 // number of units per group
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Stolen Hunter MRAP", // task title
		"We've spotted some sort of road blockage where the enemy has seized one of our own vehicles and spare parts!", // task description
		["repair","destroy"], // task roles
		"ROAD", // task icon
