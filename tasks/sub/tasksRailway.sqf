...
///////////////////////////////////////////////////////////////////////////////////////////////////
#include "tasksRailwayConfig.sqf"; // configuration for tasks.
///////////////////////////////////////////////////////////////////////////////////////////////////
_taskChosen = [];
...
if ((_taskChosen select 0) in RELO_var_locationTasksActive) exitWith
{
	...
	#endif
	if (isNil "noSuitableTasksRailway") then
	{
		noSuitableTasksRailway = 1;
	}
	else
	{
		noSuitableTasksRailway = noSuitableTasksRailway + 1;
		if (noSuitableTasksRailway > count _taskArr) exitWith
		{
			RELO_var_locationTaskAmount = RELO_var_locationTaskAmount - 1;
			noSuitableTasksRailway = nil;
			#ifdef __DEBUG__
				"  ! exhausted suitable railway tasks, adjusted total task amount!" remoteExec ["RELO_fnc_systemChatGlobal",[0,-2] select isDedicated];
				diag_log "  ! exhausted suitable railway tasks, adjusted total task amount!";
			#endif
		};
	};
};
...
_railwayTrack = nearestTerrainObjects [_taskLocation, ["RailWay"], 12.5] select 0;
if !(isNil "_railwayTrack") then
{
	_taskDirection = getDir _railwayTrack;
};
///////////////////////////////////////////////////////////////////////////////////////////////////
_baseChosen = selectRandom _taskBase;
_baseComposition = call compile preProcessFileLineNumbers format ["bases\sub\railway\%1.sqf",_baseChosen];
...
[_task,_taskMkr,_taskMkrExact,_taskUnits,_taskGroups] spawn
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	_scriptName = format ["tasksRailway: Respawn Handler For Task %1, Units %2, Groups %3",_task,_taskUnits,_taskGroups];
