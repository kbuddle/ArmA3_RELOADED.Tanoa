...
[
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Bridge Blockage", // task title
		"The enemy have blocked the bridge, go secure it soldiers!", // task description
		["secure"], // task roles
		"RESTRICTIONSHIELD", // task icon
		200, // task area radius (red outer circle)
		20, // task base radius (for base placement)
		[
			"baseBridgeCharlie_RH",
			"baseBridgeRoadblock_RH"
		], // base compositions available
		"bridge", // location surface "land", "water", "bridge"
		2, // number of unit groups
		6 // number of units per group
	],
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Bridge Take Over", // task title
		"The enemy have taken over a bridge... go take it back soldiers!", // task description
		["secure"], // task roles
		"RESTRICTIONSHIELD", // task icon
		200, // task area radius (red outer circle)
		20, // task base radius (for base placement)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Bridge Restriction", // task title
		"The enemy have restricted bridge access to themselves only, we can't let that happen now, can we soldiers?", // task description
		["secure"], // task roles
		"RESTRICTIONSHIELD", // task icon
		200, // task area radius (red outer circle)
		20, // task base radius (for base placement)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	[
		"Bridge Intel", // task title
		"CSAT have taken over a bridge and are using it as a checkpoint to gather intel, go secure it soldiers!", // task description
		["secure"], // task roles
		"SPEAKERNOTES", // task icon
		200, // task area radius (red outer circle)
		20, // task base radius (for base placement)
		[
			"BridgeIntelSecure_CM"
		], // base compositions available
		"bridge", // location surface "land", "water", "bridge"
		2, // number of unit groups
		6 // number of units per group
