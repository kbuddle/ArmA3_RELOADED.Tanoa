...
[
	[
		"Contingency Operating Base", // task title
		"Contingency Operating Base - The enemy have set up their COB... you need to work together in order to take it over and eradicate all the enemy!", // task description
		["attack","secure","repair","steal","damage","dismantle","destroy","deactivate"], // task role
		"NAVIGATION", // task icon
		250, // task map marker radius
		25, // task base area radius
		[
			"baseCOBDelta_RH",
			"baseCOBEcho_RH",
			"baseCOBFoxtrot_RH",
			...
			"baseCOB_Juliett_RH",
			"COBbasaltWallOne"
		], // task bases available to use
		"land", // task location surface "land", "water", "bridge"
		4,
		6 // 4 * 6 = 24 spawned ground patrol
	]
];
///////////////////////////////////////////////////////////////////////////////////////////////////
_soldierClasses =
