...
///////////////////////////////////////////////////////////////////////////////////////////////////
#include "tasksMainConfig.sqf"; // configuration for tasks.
///////////////////////////////////////////////////////////////////////////////////////////////////
_taskChosen = [];
...
if ((_taskChosen select 0) in RELO_var_locationTasksActive) exitWith
{
	...
	#endif
	if (isNil "noSuitableTasksBase") then
	{
		noSuitableTasksBase = 1;
	}
	else
	{
		noSuitableTasksBase = noSuitableTasksBase + 1;
		if (noSuitableTasksBase > count _taskArr) exitWith
		{
			RELO_var_locationTaskAmount = RELO_var_locationTaskAmount - 1;
			noSuitableTasksBase = nil;
			#ifdef __DEBUG__
				"  ! exhausted suitable base tasks, adjusted total task amount!" remoteExec ["RELO_fnc_systemChatGlobal",[0,-2] select isDedicated];
				diag_log "  ! exhausted suitable base tasks, adjusted total task amount!";
			#endif
		};
	};
};
...
_notificationRemoteExec = [_taskIcon,['AO MAIN TASK',_taskTitle]] remoteExec ['RELO_fnc_notificationGlobal',0,FALSE];
...
_baseComposition = call compile preProcessFileLineNumbers format ["bases\main\%1.sqf",_baseChosen];
...
while {sleep 0.1; _i < _taskGroups} do
{
	...
	if ((_i isEqualTo 0) || (_i isEqualTo 1)) then
	{
		// _unitDefend = [_leader,_unitPatrolArea] call BIS_fnc_taskDefend; // set the first two groups to defend!
		_unitPatrolArea = _taskMkrExact;
...
[_task,_taskMkr,_taskMkrExact,_taskUnits,_taskGroups] spawn
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	_scriptName = format ["tasksMain: Respawn Handler For Task %1, Units %2, Groups %3",_task,_taskUnits,_taskGroups];
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	RELO_var_locationCOBTroop = RELO_var_locationCOBTroop + (_taskGroups * _taskUnits);
	///////////////////////////////////////////////////////////////////////////////////////////////
	while {sleep 10; _task in RELO_var_locationTasksActive} do
	{
		...
		_currentCount = RELO_var_locationCOBTroop - _unitCount;
