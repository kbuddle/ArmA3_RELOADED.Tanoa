[] spawn {
	...
	// added key bind for use with HOME key for view settings.
	(findDisplay 46) displayAddEventHandler ["KeyDown", {
		if (_this select 1 == 0xC7) then // used HOME key
		{
	...
	[] spawn {
		scriptName "CHVD_fncl_currentVehicle";
	...
	[] spawn {
		scriptName "CHVD_fncl_UAVstatus";
		for "_i" from 0 to 1 step 0 do {
