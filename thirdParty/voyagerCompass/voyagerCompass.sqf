...
/*
	...
	Methods of usage:
		...
		mission-creators : init.sqf
			_x = [] execVM "voyagerCompass.sqf";

	  addon-users : console or trigger
			_x = [] spawn GTX_fnc_voyagerCompass;
...
fnc_loadCompass = {
  ...
  _compassNeedle ctrlSetStructuredText parseText format["<t shadow=2><t shadowColor='#ff0000' align='center' size='%1' color='#ffffff'>|</t>", 1];
