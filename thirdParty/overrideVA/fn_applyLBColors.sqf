...
['showMessage',[_display,"Red loadouts have restricted items that will be removed when loaded"]] call bis_fnc_arsenal;

_fnc_setLnBEntry = {
	params[ "_name", [ "_isOK", true ] ];

	_color = [ [ 1, 0.2, 0.2, 1.0 ], [ 1, 1, 1, 1 ] ] select _isOK;
