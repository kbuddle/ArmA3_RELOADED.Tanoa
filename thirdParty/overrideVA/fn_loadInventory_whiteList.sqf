...
if ( _uniform != "" ) then {
	if ( CONDITION( _uniform ) ) then {
		...
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Uniform", _uniform ];
	};
};
...
if ( _vest != "" ) then {
	if ( CONDITION( _vest ) ) then {
		...
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Vest", _vest ];
	};
};
...
if ( _headgear != "" ) then {
	if ( CONDITION( _headgear ) ) then {
		...
		_notAllowed = true;
		_headgear = getText (configFile >> "cfgWeapons" >> _headgear >> "displayName");
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Headgear", _headgear ];
	};
};
...
if ( _goggles != "" ) then {
	if ( CONDITION( _goggles ) ) then {
		...
		_notAllowed = true;
		_goggles = getText (configFile >> "cfgGlasses" >> _goggles >> "displayName");
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Goggles", _goggles ];
	};
};
...
if ( _backpack != "" ) then {
	if ( CONDITION( _backpack ) ) then {
		...
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Backpack", _backpack ];
	};
};
...
//WEAPON MAGAZINES
{
	if (_x != "" ) then {
		if ( CONDITION( _x ) ) then {
			...
			_notAllowed = true;
			_magazine = getText (configFile >> "cfgMagazines" >> _x >> "displayName");
			_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Magazine", _magazine ];
			// _notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Magazine", _x ];
		};
	};
...
//WEAPONS
{
	if ( _x != "" ) then {
		if ( CONDITION( _x ) ) then {
			...
			_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Weapon", _weapon ];
			// _notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Weapon", _x ];
		};
	};
	...
	_weaponType = _forEachIndex;
	{
		if ( _x != "" ) then {
			if ( CONDITION( _x ) ) then {
				...
				_itemDes = getText (configFile >> "cfgWeapons" >> _x >> "displayName");
				_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, _item, _itemDes ];
				// _notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, _item, _x ];
			};
		};
	}forEach _x;
...
//UNIFORM ITEMS
{
	if ( CONDITION( _x ) ) then {
		...
		_notAllowed = true;
		_uniformItem = getText (configFile >> "cfgWeapons" >> _x >> "displayName");
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Uniform Item", _uniformItem ];
		// _notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Uniform Item", _x ];
	};
...
//VEST ITEMS
{
	if ( CONDITION( _x ) ) then {
		...
		_notAllowed = true;
		_vestItem = getText (configFile >> "cfgVehicles" >> _x >> "displayName");
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Vest Item", _vestItem ];
	};
...
//BACKPACK ITEMS
{
	if ( CONDITION( _x ) ) then {
		...
		_notAllowed = true;
		_backpackItem = getText (configFile >> "cfgVehicles" >> _x >> "displayName");
		_notification = format[ "<t align='center'>%1</t><br /><t align='left'>%2 - %3</t>", _notification, "Backpack Item", _backpackItem ];
	};
