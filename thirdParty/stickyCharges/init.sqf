...
#define STICKY_CHARGE_ADDON_PATH "thirdParty\stickyCharges" // mission folder path where this script is placed
...
// these event handlers need to be readded each respawn...
