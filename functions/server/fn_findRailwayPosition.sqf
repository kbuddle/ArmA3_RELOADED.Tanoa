/*
	...
	Name: fn_findRailwayPosition.sqf
	Version: 1.0
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
	if (_forEachIndex % 2 == 0) then
	{
		...
		if (_mapPosCurr inArea _terrainMarker) then
		{
			...
			{
				_object = _x;
				if ((["railwaycar", getModelInfo _object select 0] call BIS_fnc_inString) || (["locomotive", getModelInfo _object select 0] call BIS_fnc_inString) || (["bridge", getModelInfo _object select 0] call BIS_fnc_inString)) exitWith
				{
					_exemptFound = true;
				};
			} forEach (nearestObjects [_mapPosCurr, [], 12.5]);
			///////////////////////////////////////////////////////////////////////////////////////////////
			...
			///////////////////////////////////////////////////////////////////////////////////////////////
			if ((_exemptFound isEqualTo false) && (_isBaseCompositionClose isEqualTo false)) then
			{
				_terrainPosArr pushBackUnique _mapPosCurr;
			};
		};
	};
} forEach (nearestTerrainObjects [RELO_var_locationMkrPos, ["RailWay"], RELO_var_locationMkrSize]);
///////////////////////////////////////////////////////////////////////////////////////////////
...
{
	locationRailwayArr = _terrainPosArr;
};
