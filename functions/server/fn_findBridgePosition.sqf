/*
	...
	Name: fn_findBridgePosition.sqf
	Version: 1.0
...
_locationDescription = "bridge";
_locationMarkerColor = "colorPink";
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	{
		_bridgeFound = false;
		_isOnRoad = isOnRoad getPos _terrain;
		{
			_object = _x;
			if ((["bridgewooden_", getModelInfo _object select 0] call BIS_fnc_inString) && (_isOnRoad isEqualTo false)) exitWith
			{
				_bridgeFound = true;
			};
		} forEach (nearestObjects [_mapPosCurr, [], _maxRadius]);
		_isEmpty = !(_mapPosCurr isFlatEmpty  [0, -1, -1, -1, -1, false, _terrain] isEqualTo []);
		///////////////////////////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
		if ((_bridgeFound isEqualTo true) && (_isEmpty isEqualTo true) && (_isBaseCompositionClose isEqualTo false)) then
		{
			_terrainPosArr pushBackUnique _mapPosCurr;
		};
	};
} forEach ([RELO_var_locationMkrPos select 0, RELO_var_locationMkrPos select 1] nearRoads (RELO_var_locationMkrSize));
///////////////////////////////////////////////////////////////////////////////////////////////
...
{
	RELO_var_locationBridgeArr = _terrainPosArr;
};
