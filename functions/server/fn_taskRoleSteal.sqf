...
///////////////////////////////////////////////////////////////////////////////////////////////////
waitUntil {sleep 1; (alive _taskObject && ((_taskObject distance _taskLocation) > 1000)) || !(alive _taskObject) || !(_locationMkrCurr isEqualTo RELO_var_locationMkrCurr)};
///////////////////////////////////////////////////////////////////////////////////////////////////
...
else
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////
	_taskTitle call BIS_fnc_taskDescription params ["_taskDescriptionCurr","_taskTitleCurr","_taskMkrCurr"];
	_taskDescriptionUpdate = format ["%1 FAILED? What happened soldier?",_taskDescriptionCurr select 0];
	[_taskTitle,[_taskDescriptionUpdate,_taskTitleCurr,_taskMkrCurr]] call BIS_fnc_taskSetDescription;
};
///////////////////////////////////////////////////////////////////////////////////////////////////
