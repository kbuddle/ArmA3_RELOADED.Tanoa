...
///////////////////////////////////////////////////////////////////////////////////////////////////
[_taskObject,true] call RELO_fnc_vehicleDisable;
///////////////////////////////////////////////////////////////////////////////////////////////////
sleep 10;
///////////////////////////////////////////////////////////////////////////////////////////////////
_taskCreated = [_taskTitle,"CREATED",false] spawn BIS_fnc_taskSetState;
///////////////////////////////////////////////////////////////////////////////////////////////////
waitUntil {sleep 1; (getDammage _taskObject isEqualTo 1) || !(alive _taskObject) || !(_locationMkrCurr isEqualTo RELO_var_locationMkrCurr)}; // wait until object is destroyed
///////////////////////////////////////////////////////////////////////////////////////////////////
...
_explosiveChance = selectRandom [0.25,0.5,0.75];
if (round(random 1) > _explosiveChance) then
{
	_explosive = createVehicle ["satchelCharge_remote_ammo_scripted", _taskObjectPos, [], 0, "NONE"];
	_explosive setDamage 1;
};
_fireAndSmokeChance = selectRandom [0.25,0.5,0.75];
if (round(random 1) > _fireAndSmokeChance) then
{
	_fireAndSmokeAmount = selectRandom ["SMOKE_SMALL","SMOKE_MEDIUM","SMOKE_LARGE","FIRE_SMALL","FIRE_MEDIUM","FIRE_LARGE"];
	_fireAndSmokeDuration = selectRandom [60,120,180,240,300];
	_fireAndSmoke = [_taskObjectPos, _fireAndSmokeAmount, _fireAndSmokeDuration] remoteExec ["RELO_fnc_fireAndSmoke",[0,-2] select isDedicated];
};
///////////////////////////////////////////////////////////////////////////////////////////////////
