/*
	...
	Name: fn_findRunwayPosition.sqf
	Version: 1.0
...
_locationDescription = "runway";
_locationMarkerColor = "colorRed";
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
		...
		{
			if (!(isOnRoad _mapPosCurr) && (["invisibleroadway", getModelInfo _terrain select 0] call BIS_fnc_inString)) then
			{
...
{
	_object = _x;
	_mapPosCurr = getPos _object;
	if ((["hangar", typeOf _object] call BIS_fnc_inString)) then
	{
		_terrainPosArr pushBackUnique _mapPosCurr;
	};
} forEach (nearestObjects [RELO_var_locationMkrPos, ["building"], (RELO_var_locationMkrSize)]);
///////////////////////////////////////////////////////////////////////////////////////////////
...
if !(_terrainPosArr isEqualTo []) then
{
	_terrainPos = selectRandom _terrainPosArr;
	#ifdef __DEBUG__
		{
			...
			_terrainMarkerTemp setMarkerType "mil_triangle";
...
{
	RELO_var_locationRunwayArr = _terrainPosArr;
};
