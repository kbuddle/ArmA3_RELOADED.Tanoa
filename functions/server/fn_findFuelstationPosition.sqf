/*
	...
	Name: fn_findFuelstationPosition.sqf
	Version: 1.0
...
_locationDescription = "fuel station";
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if (_mapPosCurr inArea _terrainMarker) then
	{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
		if (_isBaseCompositionClose isEqualTo false) then
		{
			_terrainPosArr pushBack _mapPosCurr;
		};
	};
} forEach (nearestTerrainObjects [RELO_var_locationMkrPos, ["fuelstation"], RELO_var_locationMkrSize]);
///////////////////////////////////////////////////////////////////////////////////////////////
