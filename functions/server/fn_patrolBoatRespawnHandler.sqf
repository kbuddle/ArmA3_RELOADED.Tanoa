...
///////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __DEBUG__
	format [" * initiated patrol boat respawn handler for %1",_vehicleName] remoteExec ["RELO_fnc_systemChatGlobal",[0,-2] select isDedicated];
	diag_log format [" * initiated patrol boat respawn handler for %1",_vehicleName];
#endif
///////////////////////////////////////////////////////////////////////////////////////////////
...
{
	// #ifdef __DEBUG__
		// format [" - patrol boat %1 has been destroyed, waiting %2 seconds for respawn!",typeOf _vehicle,_respawnDelay] remoteExec ["RELO_fnc_systemChatGlobal",[0,-2] select isDedicated];
		// diag_log format [" - patrol boat %1 has been destroyed, waiting %2 seconds for respawn!",typeOf _vehicle,_respawnDelay];
	// #endif
	sleep _respawnDelay;
	if (_locationMkrCurr isEqualTo RELO_var_locationMkrCurr) then // check if AO is still active after respawn delay
	{
		[_locationMkrName,_locationMkrInside] spawn RELO_fnc_patrolBoat;
	};
};
