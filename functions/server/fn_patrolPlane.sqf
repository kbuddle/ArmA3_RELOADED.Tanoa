...
_vehicleClasses =
[
	"O_Plane_CAS_02_dynamicLoadout_F", // To-199 Neophron (CAS) - AIR - VANILLA
	"O_Plane_Fighter_02_F" // To-201 Shikra - AIR - JETS
];

_vehicleHeightStart = 500;
...
{
	diag_log "[PATROL PLANE] -> invalid marker name, exited!";
};
///////////////////////////////////////////////////////////////////////////////////////////////////
...
_vehicle setVehicleRadar 2; // 2 = forced off.
///////////////////////////////////////////////////////////////////////////////////////////////////
...
createVehicleCrew _vehicle;
{
	...
	_skillSet = selectRandom ["VERY LOW"]; // full list = ["VERY LOW","LOW","REGULAR","MEDIUM","HIGH","ELITE"]
...
_group setGroupIdGlobal [format ["Plane Patrol - %1",_groupID]];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
[_vehicle,_locationMkrName,false] spawn RELO_fnc_patrolPlaneRespawnHandler; // individual vehicle respawn handler
