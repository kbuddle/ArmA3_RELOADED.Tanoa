/*
	...
	Name: fn_bluforBaseCleanupHandler.sqf
	Version: 1.0
	Author: soulkobk (soulkobk.blogspot.com)
	Creation Date: 12:00 PM 12/06/2017
	Modification Date: 12:00 PM 12/06/2017
	
	Description: Invade & Annex - clean up dropped items within blufor base area.
...
_cleanUpPos = getMarkerPos "bluforBase";
_cleanUpRadius = selectMax (getMarkerSize "bluforBase"); // maximum radius in meters.
...
diag_log format ["[INIT] -> Blufor Base Cleanup Handler @ Grid Position %1 with a radius of %2 meters", mapGridPosition _cleanUpPos, _cleanUpRadius];
