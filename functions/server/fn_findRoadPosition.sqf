...
_locationDescription = "road";
_locationMarkerColor = "colorBlack";
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
	if (_forEachIndex % 2 == 0) then
	{
		...
		{
			_connectedRoads = roadsConnectedTo _terrain;
			if (count _connectedRoads >= 2) then
			{
				if ((isOnRoad _mapPosCurr) && !([ "bridge", getModelInfo _terrain select 0 ] call BIS_fnc_inString)) then
				{
...
{
	RELO_var_locationRoadArr = _terrainPosArr;
};
