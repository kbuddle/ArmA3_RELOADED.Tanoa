/*
	...
	Name: fn_findForestPosition.sqf
	Version: 1.0
...
_locationDescription = "forest";
_locationMarkerColor = "colorGUER";
...
for "_i" from -_mw to _mw step _locationMkrSteps do
{
	for "_j" from -_mh to _mh step _locationMkrSteps do
	{
		...
		{
			if ((surfaceType [_mapPosCurr select 0, _mapPosCurr select 1]) isEqualTo "#GdtForest") then
			{
				_isOnRoad = isOnRoad _mapPosCurr;
				_isNearRoad = !(_mapPosCurr nearRoads (_maxRadius * 2) isEqualTo []);
				_isFlat = !(_mapPosCurr isFlatEmpty  [-1, -1, _maxGradient, _maxRadius, -1] isEqualTo []);
				///////////////////////////////////////////////////////////////////////////////////////////////
				...
				///////////////////////////////////////////////////////////////////////////////////////////////
				// if ((_mapPosCurr inArea _terrainMarker) && (_isFlat isEqualTo true) && (_isOnRoad isEqualTo false) && (_isNearRoad isEqualTo false) && (_isBaseCompositionClose isEqualTo false)) then
				if ((_isFlat isEqualTo true) && (_isOnRoad isEqualTo false) && (_isNearRoad isEqualTo false) && (_isBaseCompositionClose isEqualTo false)) then
				{
...
{
	RELO_var_locationForestArr = _terrainPosArr;
};
