...
_locationDescription = "path";
_locationMarkerColor = "colorBrown";
...
///////////////////////////////////////////////////////////////////////////////////////////////
{
	if (_forEachIndex % 2 == 0) then
	{
		...
		{
			if (!(isOnRoad getPos _terrain) && !(["bridge", getModelInfo _terrain select 0] call BIS_fnc_inString) && ((getModelInfo _terrain select 0) isEqualTo "")) then
			{
...
{
	RELO_var_locationPathArr = _terrainPosArr;
};
