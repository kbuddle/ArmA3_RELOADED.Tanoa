/*
	...
	Modification Date: 3:37 PM 19/02/2018
	...
	1.0.2 - fixed the overfill check (crates will not overfill).
...
_overallLoopAmount = 999; // set to 999 to completely fill the crate... with added overfill protection added in to the loop
...
// _loadCrateWithWhatArray = selectRandom [_crateOne,_crateTwo,_crateThree,_crateFour,_crateFive,_crateSix,_crateSeven,_crateEight,_crateNine];
...
for [{_i = 0},{_i < _overallLoopAmount},{_i = _i + 1}] do
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	// check if object has a container, if not, exit.
